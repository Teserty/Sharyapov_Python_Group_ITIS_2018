...
def drow_about():
    ...
    # An : FONT_COLOR const
    textSurfaceHello = fontAcmeL.render('Hello!',True, FONT_COLOR)
    textSurfaceWe = fontAcmeM.render('We are Niaz and Dilyara' ,True, FONT_COLOR)
    textSurfaceHope = fontAcmeM.render('We hope you enjoy our game' ,True, FONT_COLOR)
    textSurfaceGoBack = fontAcmeS.render('back', True, FONT_COLOR)
