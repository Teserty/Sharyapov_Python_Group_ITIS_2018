...
def well_done_draw(score):
    ...
    # An : FONT_COLOR const
    textSurfaceWell = fontAcmeL.render('Well done!',True, FONT_COLOR)
    textSurfacePoint = fontAcmeM.render(playerScoreSt,True, FONT_COLOR)
    textSurfacePointEmpty = fontAcmeM.render(playerScoreStEmpty, True, FONT_COLOR)

    #эти две строчки не надо
    '''
    Раз не надо, почему они не
    закомменчены или удалены??
